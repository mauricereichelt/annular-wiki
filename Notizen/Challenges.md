...
**Aufbau (entschieden 04.09.2026, [C-137 ✓](#c-137-detailabschnitte-ab-c-099-stehen-unter-der-falschen-überschrift-)):** Die **Übersicht** unten trennt nach *offen* und *gelöst*. Der **Detailteil** darunter steht durchgehend **aufsteigend nach Nummer** - ein Eintrag wird nie verschoben, wenn er sich löst; es ändert sich nur der Marker am Titel und sein Platz in der Übersicht. Anker und Links bleiben dadurch stabil.

**Marker am Challenge-Titel** (entschieden 05.09.2026, [C-148 ✓](#c-148-der-statusmarker-im-titel-bricht-die-anker-), Regel: [Regeln.md](Regeln.md#status-marker-in-challengesmd)): Jeder Titel endet auf ein Leerzeichen plus genau ein Zeichen - `○` offen · `✓` entschieden · `✗` gestrichen oder zurückgezogen. Nie ohne Marker, nie mit Zusatzwort dahinter: beides verschiebt den Anker und bricht jede Verlinkung. Maßgeblich für den Status ist die Übersicht.

**Status-Marker in den übrigen Wiki-Dateien** (Details: [Regeln.md](Regeln.md)): `???` = noch zu entscheiden · `bewusst offen` = abgesegnet, bleibt offen · konkreter Inhalt = entschieden. `bewusst offen` und Status `final` setzt ausschließlich der Autor.
...
Randnotiz des Autors in der [Kapitelskizze](../Plots/Plot-1/Kapitelstruktur.md#prolog). Damit Tibun **einziger Zeuge** sein kann, braucht es einen Grund, warum Mutter und Sohn bei aufziehendem Gewitter außerhalb des Weilers sind.

**Entschieden (Autor, 07.09.2026): die Schafe.** Girlin ist wegen der Tiere draußen - Sorge um sie oder ihre Flucht vor dem Gewitter; Tibun hilft ihr mit den Tieren. Ein Alltagsgrund, kein Zufall. Steht in den Szenen *Der Blitz - Girlin* und *Der Blitz - Tibun* ([Szenen.md](../Plots/Plot-1/Szenen.md)).
...
#### Das Tabu
**Benennung (Autor, 07.09.2026):** Das Dorf nennt den Ort die **Tabustelle**; **der Ring** ist Tibuns Bezeichnung. Beide Wörter meinen dieselbe Stelle an der Skir und werden je nach Sicht gebraucht.
...
**Entschieden (Autor, 07.09.2026): die [Wala von Tingsal](../Menschen/Nordvolk/Nebenfiguren/Wala-Tingsal.md).** Der [wandernden Wala](../Menschen/Nordvolk/Nebenfiguren/Wala-Wandernd.md) kann Semund nicht nachreisen: **Niemand weiß, wo sie sich aufhält - außer ihrer Zwillingsschwester in Tingsal.** Wer eine Wala braucht, geht deshalb nach Tingsal.

**Die Walas sprechen als eine Stimme** - als die Stimme der Götter. Die eine hält sich an das Wort der anderen. Die Toterklärung Girlins gilt in Tingsal also ohne erneute Prüfung, und die Erlaubnis ist kein zweites Urteil, sondern dieselbe Stimme an einem anderen Ort. **Für Tibun heißt das: es gibt keine zweite Instanz.** Wohin er sich auch wendet, er bekommt dieselbe Antwort.
...
- Es gehört zu den ersten Dingen, die er begreift - und zu den ersten, die ihm niemand glaubt. Es sitzt damit genau auf dem Konflikt, der seinen ganzen Strang trägt.

**Folge:** Weil er die Grenze kennt, baut er seine Anlage **außerhalb** des Kugelvolumens → [C-102](#c-102-was-bei-zündung-1-aus-dem-norden-verschwindet-).

**Nachgezogen:** [Zeitleiste](../Plots/Plot-1/Zeitleiste.md) (Jahr 0).
...
> Beim Flip liegt die **Kette oben im Dachstuhl**, der Stromkreis ist **offen** ([C-099](#c-099-der-isolierte-konduktor---ladungsspeicher-ohne-anachronismus-)). Der Konduktor hängt in diesem Moment gar nicht am Ring und **bleibt geladen**. Tibun kann **jederzeit** zünden.

Das fällt sauber aus der Kettenlösung selbst und braucht keine Sonderregel.

**Folge für das Finale - und sie ist besser als die verworfene Fassung:** Die Spannung im Kampf ist **nicht** *„wie lange muss er noch durchhalten"*, sondern *„er könnte jederzeit, wenn er nur die Hand frei bekäme"*. Unmittelbarer, kürzer, härter.
...
Die Kopplung ist eine Eigenschaft des **Ringpaares**, nicht des Standorts ([C-010 ✓](#c-010-ringsystem---kopplungsmechanik-)). Ein Ring lässt sich beliebig versetzen, ohne dass die Verbindung leidet - was der Transport in [C-018 ✓](#c-018-widerspruch---transport-des-wüstenrings-) voraussetzt.
...
**Zu klären, welche Lesart gilt · ???**
- **(a) Volle Verständigung ab dem ersten Treffen** - dann ist Bellbrims Auftritt Girlins Erlösung, und die Sprachlosigkeit endet exakt dort. Die Skizze stützt das: *„Bellbrim kann endlich übersetzen"* (Girlin 8).
...
Der Grund liegt nicht in Erkenntnis, sondern in Arithmetik: Eine Reise zu Fuß aus dem [Fezzan](../Kulturen/Kel-Aman/README.md) nach Nordjütland ist **lang, teuer, unbekannt und lebensgefährlich** - für eine Frau ohne Sippe, ohne Sprache und ohne Mittel keine Möglichkeit, sondern eine Todesart. Der Ring hat sie hergebracht; **er ist die einzige Rückrichtung, die überhaupt denkbar ist.**

**Was daraus folgt - und es ist mehr, als die Frage wert schien:**
- Ihr Strang hat **kein Erweckungserlebnis** und braucht keins. Sie beginnt nicht bei null, sondern bei einem Ziel, das feststeht, und alle zehn Jahre gehen für das **Wie** drauf, nicht für das **Ob**.
- Der **Ringstandort** wird damit zur zentralen Frage ihres Lebens - und das Schweigen des Häuptlings ([C-061](#c-061-navigationswissen-des-häuptlings-)) zum größten Verrat, den man an ihr begehen kann. Er verstellt ihr nicht *einen* Weg, sondern **den einzigen**.
- Ihr Entschluss zu bleiben ([C-082 ✓](#c-082-girlins-entscheidung-zur-rückreise-)) wiegt entsprechend schwerer: Sie gibt nicht eine Hoffnung auf, sondern die einzige, die sie je hatte.

**Nachgezogen:** [Zeitleiste](../Plots/Plot-1/Zeitleiste.md).
...
**Entschieden (Autor, 02.09.2026): Es kommen Stationen hinein.** Die Wanderschaft wird **nicht** zusammengefasst und übersprungen.

**Zu klären · ???**
- **Wie viele Stationen**, und wo auf dem Ochsenweg?
- **Was ändert sich in jeder?** Eine Station ist nur dann ein Kapitel, wenn sie etwas verändert - sonst ist sie Reisebericht.
- **Wovon lebt er?** → [C-034](#c-034-tibuns-lebensgrundlage-während-der-wanderschaft-). Ein Siebzehnjähriger ohne Sippe ist in dieser Epoche schutzlos; er braucht einen sozialen Mechanismus (Gastrecht, Anschluss an einen Händlerzug, Dienstverhältnis) - ohne den bricht die Wanderschaft das Authentizitätsprinzip härter als jeder falsche Gegenstand.
- **Was treibt ihn weiter, statt zu bleiben?** Acht Jahre sind lang genug, um irgendwo ein Leben anzufangen. Warum tut er es nicht - und **wo wäre er beinahe geblieben?**
...
Damit ist [C-121 ✗](#c-121-zwei-generatoren-ungleiche-bauzeiten-) zurückgezogen - sie beruhte selbst auf der Annahme, beide Stränge bauten dasselbe.
...
**Entschieden (Autor, 04.09.2026): Die Trennung im Detailteil wird aufgegeben.**

Die Überschriften `## Offen` und `## Gelöst / Entschieden` sind durch **ein** `## Alle Challenges nach Nummer` ersetzt; alle 147 Abschnitte stehen dort **aufsteigend nach Nummer**. Ein Eintrag wird nie mehr verschoben, wenn er sich löst - es ändert sich nur das `✓` am Titel und sein Platz in der **Übersicht** am Kopf, die weiterhin nach offen/gelöst trennt.

**Warum das trägt:** Anker hängen an der Überschrift, nicht an der Position. Nach dem Umbau wurden alle **147 dateiinternen** und alle **219 aus anderen Dateien** kommenden Ankerverweise geprüft - kein toter Link. Der Inhalt aller 147 Abschnitte wurde blockweise gegen den Stand davor verglichen: keine Abweichung.

*Der Titel dieses Eintrags bleibt unverändert, damit die auf ihn zeigenden Links gültig bleiben.*
...
**Was dadurch neu offen ist:** [C-141](#c-141-der-auftakt-ist-jetzt-sehr-dicht-) (Dichte des Auftakts) · [C-142](#c-142-wie-die-geschriebenen-szenen-gegliedert-werden-) (Ordnerstruktur).
...
**Nicht gedeckt · ???** Alles Übrige: **wo geschnitten wird** (welche Ereignisse eine Szene bilden), die **44 Titel**, und die Formulierungen in **Will / Hindernis / Ausgang**. Die Ereignisse selbst stammen aus [Zeitleiste.md](../Plots/Plot-1/Zeitleiste.md) und sind gedeckt; ihre **Bündelung zu Szenen** ist eine Lesart.
...
- **Nr. 26 · Das Tischmodell** - Hindernis `???`, wird also mitgezählt; der Ausgang sagt zusätzlich *„kein Rückschlag, kein Gegenspieler"* über **vier Jahre** Erzählzeit.
...
- Sie stand **vollständig innerhalb der Ringöffnung** und reist deshalb unverletzt ([C-012 ✓](#c-012-aktivierungsverhalten-des-rings-))
- Sie **wacht** in der Wüste **auf** ([Zeitleiste](../Plots/Plot-1/Zeitleiste.md)) - war zwischenzeitlich also nicht bei Bewusstsein
- Der Ring hat sie hergebracht, und das ist ihr **von Anfang an klar** ([C-114 ✓](#c-114-girlin-weiß-von-anfang-an-dass-der-ring-ihr-rückweg-ist-))
...
**Herkunft der Ungenauigkeit:** In Szenen.md stand unter *Zählung*, die Nummer sei die „chronologische Position". Der Satz stammt von **Claude**, nicht vom Autor. Er ist ersetzt und trägt am Ort einen Streichvermerk (vgl. [C-119](#c-119-wiki-altlast---vom-autor-nicht-gedeckte-festlegungen-)).

**Bleibt offen:** [C-139](#c-139-erzählreihenfolge---verschränkt-oder-blockweise-) - ob verschränkt oder blockweise erzählt wird. Diese Entscheidung legt fest, *was* die Erzählreihenfolge ist, nicht mehr, *ob* sie die maßgebliche ist.
...
**Das Problem war strukturell, nicht Schlamperei.** Der Anker einer Überschrift wird aus ihrem Text gebildet. Hängte man ein `✓` an einen Titel, der vorher keins trug, änderte sich der Anker - aus `#c-034-…-wanderschaft` wurde `#c-034-…-wanderschaft-` mit angehängtem Bindestrich, und jede Verlinkung darauf brach. Wer den Marker nachzog, musste alle Links mitziehen; wer es ließ, hatte einen falschen Status. Neun Einträge standen deshalb ohne Marker da (C-034, C-061, C-100, C-104, C-107, C-115, C-122, C-123, C-137).

**Entschieden (Autor, 05.09.2026): Jeder Titel trägt immer einen Marker - Leerzeichen, dann genau ein Zeichen.**
...
**Warum das die Anker stabil hält:** Der Slugger wirft das Markerzeichen weg und wandelt danach Leerzeichen in Bindestriche. Steht **immer** genau ein Leerzeichen plus ein Zeichen am Ende, endet der Anker **immer** auf `-` - unabhängig davon, welcher der drei Marker dort steht. Ein Wechsel `○ → ✓ → ✗` lässt den Anker unverändert.

```
### C-034: Tibuns Lebensgrundlage während der Wanderschaft ○  →  #c-034-…-wanderschaft-
### C-034: Tibuns Lebensgrundlage während der Wanderschaft ✓  →  #c-034-…-wanderschaft-
```

**Was das verbietet:** Zusatzwörter nach dem Marker. `✗ gestrichen`, `✗ zurückgezogen` und `✓ (Kernfrage)` standen so in den Titeln von C-080, C-121 und C-111 - sie hätten den Anker wieder verschoben und sind entfernt; die Begründung steht ohnehin im Abschnittstext. Festgeschrieben in [Regeln.md](Regeln.md#status-marker-in-challengesmd).
