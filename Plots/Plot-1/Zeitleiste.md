...
Interne Chronologie (Autorenebene). Erzählreihenfolge der Kapitel: [Kapitelstruktur](Kapitelstruktur.md) (eingefrorene Handskizze, wird nicht nachgepflegt). Der **Szenenzuschnitt** - welche Ereignisse in eine Szene fallen und was jede Szene will - steht in [Szenen.md](Szenen.md); diese Datei bleibt die Quelle für die **Ereigniskette**, jene für den **Zuschnitt**. Jahre relativ zu **Girlins Verschwinden = Jahr 0** (dem auslösenden Ereignis). Konkrete Jahreszahlen erscheinen nicht im Erzähltext (Referenzjahr 550 n.Chr.).
...
- Semund bindet sich **rasch** neu an [Millia](../../Menschen/Nordvolk/Nebenfiguren/Millia.md) - für Tibun ein Verrat, denn er **weiß**, dass Girlin lebt
- **Die Reise nach Tingsal** (Autor, 07.09.2026): Semund und Millia reisen nach [Tingsal](../../Orte/Tingsal.md) und holen dort die Erlaubnis bei der [**Wala von Tingsal**](../../Menschen/Nordvolk/Nebenfiguren/Wala-Tingsal.md). Semund **will Tibun mitnehmen**, Tibun will nicht
...
- **[Kaupvik](../../Orte/Kaupvik.md), Jahr +1 bis +9 - rund acht Jahre an einem Ort.** Er bleibt aus zwei Gründen: Er **braucht das Wissen**, und er **sammelt Bernstein und Ressourcen** - durch Handel *und* durch eigenes Sammeln. Bernstein in der nötigen Menge ist nicht zu kaufen wie Brot; das Sammeln selbst kostet die Jahre
  ...
  - **+4/+5: Arbeitsunfall an einer Bootsziehwinde** → **Erkenntnismoment**: schnelle, kontinuierliche Reibung = viel Ladung. Ein **Traum zur Winde** hilft ihm dabei (Autor, 15.09.2026)
...
- **Die Werkstatt fasst Ring und Bernsteinrad** und reicht dafür die Böschung hinunter bis ans Wasser (vorläufig, Autor, 15.09.2026). Sie ist ein **langgestreckter Bau, dessen Dach mit der Böschung abfällt**, gedeckt mit **Reet** (Autor, 18.09.2026). Wände, Fundament und Aussehen: **???**
...
- **Der Konflikt mit dem Weiler** (entschieden 02.09.2026):
  ...
  - **Niemand aus dem Weiler kommt an die Tabustelle** (Autor, 18.09.2026): **[Truda](../../Menschen/Nordvolk/Nebenfiguren/Truda.md) meidet sie ebenso wie die neugierigen Kinder.** Das Tabu hält ohne Ausnahme. Die einzige Person, die den Ort betritt, ist die gerufene **[Wala](../../Menschen/Nordvolk/Nebenfiguren/Wala-Wandernd.md)**. Beim Bau ist Tibun **vollständig allein**
  - > **Geändert (18.09.2026):** Hier stand *„Truda und neugierige Kinder meiden ihn nicht ganz - sie sind die einzige Verbindung zum Weiler"* (02.09.2026). Diese Verbindung gibt es nicht mehr. Der Kontakt zu Truda bleibt, er findet nur **woanders** statt; **wo der Weiler-Konflikt Tibun überhaupt erreicht**, ist damit offen: **???**
...
Entschieden 31.08.2026. Nicht *entweder* Wüste *oder* Norden zündet - **beide, nacheinander**. Damit bleibt die Gleichzeitigkeit des Ringtauschs gültig, und Tibuns zehn Jahre Arbeit werden trotzdem ausgezahlt.
