...
**Ob und wie tief eine Hochkultur so einen Ring einlässt, ist offen · ???** Hier standen zuvor konkrete Einbaumaße (Zentrum 0,75 m über dem Gehweg, Grubensohle 0,90 m darunter, Zeitfenster im Gehen) - sie beruhten auf einer erfundenen Betriebsregel und sind gestrichen.
...
Das Material ist mystisch und nicht identifizierbar. Für die Bearbeitung gilt:
...
> **Optikreferenz, kein Material.** „Gebürstetes Aluminium" beschreibt nur, wie die Oberfläche *aussieht* - analog zur Formreferenz (flacher Armreif) und zur Berechnungsreferenz (Dichte 7,8 g/cm³). Das Material bleibt unbekannt. Der Begriff gehört auf die **Autorenebene** und darf so **nie im Erzähltext** stehen.
...
**Autorenebene.** Nichts aus diesem Abschnitt erscheint im Erzähltext - keine Figur von 550 kann diese Größen messen oder benennen. Der **3-m-Ring ist der Referenzring**; alle anderen Größen werden aus ihm abgeleitet, nicht umgekehrt. Die frühere Herleitung aus dem Einen Ring ist abgelöst.
...
Kanonisch sind nur **3,00 m** und **0,30 m**; 1,00 m und 2,00 m sind Rechenbeispiele.
...
> **Die Dichte ist eine reine Rechengröße.** 7,8 g/cm³ ist **kein Materialbeschluss** - das Material bleibt unbekannt und mystisch. Weder Material noch Gewicht werden im Erzähltext je benannt: Niemand in der Welt von 550 besitzt eine Waage, die einen solchen Körper wiegen könnte.
...
Die Eine-Ring-Referenz ist damit vollständig abgelöst; Formvorbild ist jetzt der flache Armreif.
